! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = t || self).Sweetalert2 = e() }(this, function() { "use strict";
    ...
    function st(t) { an.isVisible() && dt !== t.target.value && an.resetValidationMessage(), dt = t.target.value }
    ...
    function re() { var t = Y(),
            e = Z();
        t.style.removeProperty("align-items"), e.offsetTop < 0 && (t.style.alignItems = "flex-start") } var ae = function() { navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) || Z().scrollHeight > window.innerHeight - 44 && (Y().style.paddingBottom = "".concat(44, "px")) },
        ce = function() { var e, t = Y();
            t.ontouchstart = function(t) { e = se(t.target) }, t.ontouchmove = function(t) { e && (t.preventDefault(), t.stopPropagation()) } },
        se = function(t) { var e = Y(); return t === e || !(it(e) || "INPUT" === t.tagName || it(k()) && k().contains(t)) },
        ue = { swalPromiseResolve: new WeakMap };

    function le(t, e, n, o) { var i;
        n ? fe(t, o) : (zt().then(function() { return fe(t, o) }), $t.keydownTarget.removeEventListener("keydown", $t.keydownHandler, { capture: $t.keydownListenerCapture }), $t.keydownHandlerAdded = !1), e.parentNode && !document.body.getAttribute("data-swal2-queue-step") && e.parentNode.removeChild(e), I() && (null !== $.previousBodyPadding && (document.body.style.paddingRight = "".concat($.previousBodyPadding, "px"), $.previousBodyPadding = null), R(document.body, W.iosfix) && (i = parseInt(document.body.style.top, 10), ft(document.body, W.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * i), "undefined" != typeof window && ie() && window.removeEventListener("resize", re), h(document.body.children).forEach(function(t) { t.hasAttribute("data-previous-aria-hidden") ? (t.setAttribute("aria-hidden", t.getAttribute("data-previous-aria-hidden")), t.removeAttribute("data-previous-aria-hidden")) : t.removeAttribute("aria-hidden") })), ft([document.documentElement, document.body], [W.shown, W["height-auto"], W["no-backdrop"], W["toast-shown"], W["toast-column"]]) }

    function de(t) { var e, n, o, i = Z();
        i && (e = Pt.innerParams.get(this)) && !R(i, e.hideClass.popup) && (n = ue.swalPromiseResolve.get(this), ft(i, e.showClass.popup), pt(i, e.hideClass.popup), o = Y(), ft(o, e.showClass.backdrop), pt(o, e.hideClass.backdrop), function(t, e, n) { var o = Y(),
                i = wt && rt(e),
                r = n.onClose,
        ...
        fe = function(t, e) { setTimeout(function() { "function" == typeof e && e(), t._destroy() }) };

    function me(t, e, n) { var o = Pt.domCache.get(t);
        e.forEach(function(t) { o[t].disabled = n }) }

    function he(t, e) { if (!t) return !1; if ("radio" === t.type)
            for (var n = t.parentNode.parentNode.querySelectorAll("input"), o = 0; o < n.length; o++) n[o].disabled = e;
        else t.disabled = e } var ge = function() {
        ...
        ve = { email: function(t, e) { return /^[a-zA-Z0-9.+_-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]{2,24}$/.test(t) ? Promise.resolve() : Promise.resolve(e || "Invalid email address") }, url: function(t, e) { return /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{2,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(t) ? Promise.resolve() : Promise.resolve(e || "Invalid URL") } };

    function be(t) { var e, n;
        (e = t).inputValidator || Object.keys(ve).forEach(function(t) { e.input === t && (e.inputValidator = ve[t]) }), t.showLoaderOnConfirm && !t.preConfirm && N("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request"), t.animation = F(t.animation), (n = t).target && ("string" != typeof n.target || document.querySelector(n.target)) && ("string" == typeof n.target || n.target.appendChild) || (N('Target parameter is not valid, defaulting to "body"'), n.target = "body"), "string" == typeof t.title && (t.title = t.title.split("\n").join("<br />")), vt(t) }

    function ye(t) { var e = Y(),
            n = Z(); "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), Te(e, n, t), Ee(e, n), I() && Oe(e, t.scrollbarPadding), Q() || $t.previousActiveElement || ($t.previousActiveElement = document.activeElement), "function" == typeof t.onOpen && setTimeout(function() { return t.onOpen(n) }), ft(e, W["no-transition"]) }

    function we(t) { var e, n = Z();
        t.target === n && (e = Y(), n.removeEventListener(wt, we), e.style.overflowY = "auto") }

    function Ce(t, e) { "select" === e.input || "radio" === e.input ? Ie(t, e) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(e.input) && v(e.inputValue) && Me(t, e) }

    function ke(t, e) { t.disableButtons(), e.input ? He(t, e) : De(t, e, !0) }

    function xe(t, e) { t.disableButtons(), e(z.cancel) }

    function Pe(t, e) { t.closePopup({ value: e }) }

    function Ae(e, t, n, o) { t.keydownTarget && t.keydownHandlerAdded && (t.keydownTarget.removeEventListener("keydown", t.keydownHandler, { capture: t.keydownListenerCapture }), t.keydownHandlerAdded = !1), n.toast || (t.keydownHandler = function(t) { return _e(e, t, o) }, t.keydownTarget = n.keydownListenerCapture ? window : Z(), t.keydownListenerCapture = n.keydownListenerCapture, t.keydownTarget.addEventListener("keydown", t.keydownHandler, { capture: t.keydownListenerCapture }), t.keydownHandlerAdded = !0) }

    function Be(t, e, n) { var o = q(),
            i = 0; if (i < o.length) return (e += n) === o.length ? e = 0 : -1 === e && (e = o.length - 1), o[e].focus();
        Z().focus() }

    function Se(t, e, n) { Pt.innerParams.get(t).toast ? Ye(t, e, n) : (Qe(e), $e(e), Je(t, e, n)) } var Ee = function(t, e) { wt && rt(e) ? (t.style.overflowY = "hidden", e.addEventListener(wt, we)) : t.style.overflowY = "auto" },
        Oe = function(t, e) { var n;
        ...
        Te = function(t, e, n) { pt(t, n.showClass.backdrop), et(e), pt(e, n.showClass.popup), pt([document.documentElement, document.body], W.shown), n.heightAuto && n.backdrop && !n.toast && pt([document.documentElement, document.body], W["height-auto"]) },
        Le = function(t) { return t.checked ? 1 : 0 },
        ...
        Ie = function(e, n) {
            function o(t) { return Ve[n.input](i, Re(t), n) } var i = k();
        ...
        Me = function(e, n) { var o = e.getInput();
        ...
        Ve = { select: function(t, e, i) {
                ...
                n.length && n[0].focus() } },
        Re = function o(n) { var i = []; return "undefined" != typeof Map && n instanceof Map ? n.forEach(function(t, e) { var n = t; "object" === r(n) && (n = o(n)), i.push([e, n]) }) : Object.keys(n).forEach(function(t) { var e = n[t]; "object" === r(e) && (e = o(e)), i.push([t, e]) }), i },
        He = function(e, n) { var o = function(t, e) { var n = t.getInput(); if (!n) return null; switch (e.input) {
                    case "checkbox":
                        return Le(n);
                    case "radio":
                        return je(n);
            ...
            n.inputValidator ? (e.disableInput(), Promise.resolve().then(function() { return n.inputValidator(o, n.validationMessage) }).then(function(t) { e.enableButtons(), e.enableInput(), t ? e.showValidationMessage(t) : De(e, n, o) })) : e.getInput().checkValidity() ? De(e, n, o) : (e.enableButtons(), e.showValidationMessage(n.validationMessage)) },
        De = function(e, t, n) { t.showLoaderOnConfirm && Ft(), t.preConfirm ? (e.resetValidationMessage(), Promise.resolve().then(function() { return t.preConfirm(n, t.validationMessage) }).then(function(t) { ht(A()) || !1 === t ? e.hideLoading() : Pe(e, void 0 === t ? n : t) })) : Pe(e, n) },
        Ne = ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"],
        Ue = ["Escape", "Esc"],
        _e = function(t, e, n) { var o = Pt.innerParams.get(t);
        ...
        Fe = function(t, e, n) { if (!e.isComposing && e.target && t.getInput() && e.target.outerHTML === t.getInput().outerHTML) { if (-1 !== ["textarea", "file"].indexOf(n.input)) return;
                Vt(), e.preventDefault() } },
        ze = function(t) { for (var e = t.target, n = q(), o = -1, i = 0; i < n.length; i++)
                if (e === n[i]) { o = i; break }
        ...
        Ke = function(t, e, n) { F(e.allowEscapeKey) && (t.preventDefault(), n(z.esc)) },
        Ye = function(e, t, n) { t.popup.onclick = function() { var t = Pt.innerParams.get(e);
                t.showConfirmButton || t.showCancelButton || t.showCloseButton || t.input || n(z.close) } },
        Ze = !1,
        Qe = function(e) { e.popup.onmousedown = function() { e.container.onmouseup = function(t) { e.container.onmouseup = void 0, t.target === e.container && (Ze = !0) } } },
        $e = function(e) { e.container.onmousedown = function() { e.popup.onmouseup = function(t) { e.popup.onmouseup = void 0, t.target !== e.popup && !e.popup.contains(t.target) || (Ze = !0) } } },
        Je = function(n, o, i) { o.container.onclick = function(t) { var e = Pt.innerParams.get(n);
                Ze ? Ze = !1 : t.target === o.container && F(e.allowOutsideClick) && i(z.backdrop) } }; var Xe = function(t, e, n) { var o = L();
            nt(o), e.timer && (t.timeout = new ge(function() { n("timer"), delete t.timeout }, e.timer), e.timerProgressBar && (et(o), setTimeout(function() { t.timeout.running && at(e.timer) }))) },
        Ge = function(t, e) { if (!e.toast) return F(e.allowEnterKey) ? e.focusCancel && ht(t.cancelButton) ? t.cancelButton.focus() : e.focusConfirm && ht(t.confirmButton) ? t.confirmButton.focus() : void Be(0, -1, 1) : tn() },
        tn = function() { document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur() }; var en, nn = function(t) { for (var e in t) t[e] = new WeakMap },
        on = Object.freeze({ hideLoading: ne, disableLoading: ne, getInput: function(t) { var e = Pt.innerParams.get(t || this),
                    n = Pt.domCache.get(t || this); return n ? J(n.content, e.input) : null }, close: de, closePopup: de, closeModal: de, closeToast: de, enableButtons: function() { me(this, ["confirmButton", "cancelButton"], !1) }, disableButtons: function() { me(this, ["confirmButton", "cancelButton"], !0) }, enableInput: function() { return he(this.getInput(), !1) }, disableInput: function() { return he(this.getInput(), !0) }, showValidationMessage: function(t) { var e = Pt.domCache.get(this);
                ...
                be(e), Object.freeze(e), $t.timeout && ($t.timeout.stop(), delete $t.timeout), clearTimeout($t.restoreFocusTimeout); var n = function(t) { var e = { popup: Z(), container: Y(), content: k(), actions: E(), confirmButton: B(), cancelButton: S(), closeButton: j(), validationMessage: A(), progressSteps: P() }; return Pt.domCache.set(t, e), e }(this); return Mt(this, e), Pt.innerParams.set(this, e),
                    function(n, o, i) { return new Promise(function(t) { var e = function t(e) { n.closePopup({ dismiss: e }) };
                            ue.swalPromiseResolve.set(n, t);
                            o.confirmButton.onclick = function() { return ke(n, i) };
                            o.cancelButton.onclick = function() { return xe(n, e) };
                            o.closeButton.onclick = function() { return e(z.close) };
                            Se(n, o, e);
                            Ae(n, $t, i, e); if (i.toast && (i.input || i.footer || i.showCloseButton)) { pt(document.body, W["toast-column"]) } else { ft(document.body, W["toast-column"]) }
                            Ce(n, i);
                            ye(i);
                            Xe($t, i, e);
                            Ge(o, i);
                ...
                Object.keys(e).forEach(function(t) { an.isUpdatableParameter(t) ? o[t] = e[t] : N('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js')) }); var i = s({}, n, o);
    ...
    s(rn.prototype, on), s(rn, ee), Object.keys(on).forEach(function(t) { rn[t] = function() { if (en) return en[t].apply(en, arguments) } }), rn.DismissReason = z, rn.version = "9.14.2"; var an = rn; return an.default = an }), void 0 !== this && this.Sweetalert2 && (this.swal = this.sweetAlert = this.Swal = this.SweetAlert = this.Sweetalert2);